const record = [
  ...
  function superbowlWin(array){
    const wins = array.find(obj => obj.result === "W")   //use ternary operator to return undefined if "W" not found
        return(wins ? wins.year : undefined)    //(condition ? expression to exe. if truthy : expression to exe. if falsy)
    }

superbowlWin(record) //=> '1969'